...
export function makeFullEvent(event, session) {
  ...
  return removeNullProps({
    ...
    ClickOfferId: getExtraParam(event, 'click_offer', 'partnerId'),
    ClickOfferName: getExtraParam(event, 'click_offer', 'partnerName'),
    ClickOfferSource: getExtraParam(event, 'click_offer', 'partnerSource'),
    OfferDetailsId: getExtraParam(event, 'offer_details', 'partnerId'),
    OfferDetailsName: getExtraParam(event, 'offer_details', 'partnerName'),
